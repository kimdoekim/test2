document.addEventListener("DOMContentLoaded", function() {
    const slideArr = Array.from(document.querySelectorAll(".trending_keyword_slide"));
...
function toggleDivs() {
    ...
    if (!anyChecked) {
        ...
        document.querySelectorAll('.search_result_item').forEach(div => div.classList.remove('hidden'));
    }
}
